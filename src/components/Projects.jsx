...
const projects = [
  ...
  },
  {
    ...
    description: "A computer system that detects heart disease in real-time using AI, with automated evidence reporting the users health data.",
    tech: ["Python", "Pandas", "Machine Learning"],
  },
  {
    title: "Pavan GPT",
    description: "An intelligent, full-stack AI conversational application featuring a responsive React frontend interface integrated with a robust Django backend to manage user prompts and model responses.",
    tech: ["React.js", "Django", "Python", "JavaScript", "REST API"],
    github: "https://github.com/YPavansai/pavan-gpt",
  },
];
